...
<head>
    ...
    <title>{{ config('app.name', 'StockSentry ') }} |About To expire</title>
...
<body>
    ...
    <table class="w-full">
        <tr>
           <td class="w-half" style="text-align:center">{{$lab_name??""}} About To Expire</td>
        </tr>
    </table>
    ...
    <div class="margin-top">
         <span class="heading4" style="text-align: center;"><strong>About To Expire Items List</strong></span> <br> 
