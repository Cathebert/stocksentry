      ...
      <div class="modal-body">
        <input type="hidden" id="consolidate_marked" value="{{route('requisition.show_marked')}}"/>
        <input type="hidden" id="get_details" value="{{route('requisition.get_details')}}"/>
...
<div class="row" >
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <table class="table table-bordered table-striped table-sm" id="marked_requests" width="100%">
    ...
    console.log(rowData)
     ...
     $.ajax({
         ...
         success: function (json) {
          ...
          var info='<div class="table-responsive"><table class="table table-sm table-striped table-light"><thead> <tr>'
      info+='<th scope="col">#</th><th scope="col">Lab Name</th><th scope="col"> Requested Date</th><th scope="col">Requested By</th>'
       info+='<th scope="col">Approved By</th><th scope="col">Batch #</th><th scope="col">Cost</th> <th scope="col">Requested Quantity</th>'
...
<!----------Table end --------->
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-primary" id="update_all"  href="{{route('requisition.export')}}">Consolidate</a>
      </div>
