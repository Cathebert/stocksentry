...
<nav aria-label="breadcrumb">
  ...
  <input type="text" aria-label="First name" id="siv" class="form-control" name="siv" placeholder="" value="{{$issue}}" readonly />
  
</div>


   <div class="col-md-3 col-sm-12 col-xs-12 form-group" >
        <label for="lab_id">Issue From Store</label>
...
<hr><br>
 ...
 <button type="button" class="btn  btn-primary btn-sm " style="text-color:white"id="save_issue" style="" onclick="showApprovals()"><i class="fa fa-check" ></i>Pending Approvals  <span class="badge badge-pill badge-danger" id="requests-badge">{{$badges}}</span></button>&nbsp;&nbsp;
 
 @endif
 <button type="button" class="btn  btn-success btn-sm " style="text-color:white"id="show_approved" style="" ><i class="fa fa-check"></i>Approved <span class="badge badge-pill badge-danger" id="approved_badge">{{$approved}}</span></button>&nbsp;&nbsp;
</div>
   ...
   <br>
        ...
        <table class="table table-bordered table-striped table-sm" id="items">
  ...
  <tbody>
          ...
          <form class="form-inline" style="float:right;  margin-right:7%;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="check_quantity" value="{{route('inventory.check_quantity')}}"/>
         <div class="table-responsive">
        <table class="table table-bordered table-striped table-sm" id="issue_items" width="100%">
<thead class="thead-light">
    <tr>
        <th scope="col"></th>
