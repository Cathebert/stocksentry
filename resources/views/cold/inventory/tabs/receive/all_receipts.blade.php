  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <h5 class="card-title"> <strong>All Received Items </strong></h5>
@include("cold.inventory.tabs.receive.received_header")
<br>
...
<thead class="thead-light">
  ...
  <div class="modal-dialog modal-lg" role="document" >
    ...
    @push('js')
     <script src="{{asset('assets/admin/js/inventory/all_receive.js') }}"></script>
