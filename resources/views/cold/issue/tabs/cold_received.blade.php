...
<nav aria-label="breadcrumb">
  ...
  @include('cold.issue.tabs.cold_issue_header') 
<div class="row" >
...
<form method="post" id="form_id">
  ...
  <input type="text" aria-label="First name" class="form-control" name="siv_start">
  ...
  <input type="date" aria-label="First name" class="form-control" name="issue_start_date">
   <span class="input-group-text btn btn-secondary">-</span>
  <input type="date" aria-label="Last name" class="form-control"  name="issue_end_date">
</div>
  </div>
   <div class="col-md-3 col-sm-12 col-xs-12 form-group" >
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <button type="button" class="btn shadow-none  btn-lg" style="outline: none !important; box-shadow: none;color:white"><i class="fa fa-print"></i> Print</button>
      ...
      <li class="nav-item dropdown" >
        ...
        <table class="table table-sm table-striped" id="issue_items_table"  width="100%">
