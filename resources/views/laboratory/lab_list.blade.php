...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">All Laboratory</li>
  </ol>
</nav>
  ...
  <div class="col-sm-12">
     <br>
      ...
      <div class="card">
       ...
       <input type="hidden" id="delete_lab" value="{{route('lab.delete')}}"/>
