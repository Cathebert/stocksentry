...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <form action="#"  method="post" name="product_type_attribute_form" id="product_type_attribute_form" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right">
                    ...
                    <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th width="10%"><input class="all_view" type="checkbox">&nbsp; Approve </th>
