...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Disposed Items</li>
  </ol>
</nav>
   <!-- Page Heading -->
    <div class="row">
     ...
     <div class="col-xl-3 col-md-4 mb-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Value of disposed quantity</div>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Disposed Item Report</h1>
...
<form method="post" id="expiry_form">
          @csrf
               ...
               <input type="hidden" class="form-control" id="expiry_report" value="{{route('report.disposed_table')}}">
...
<div class="input-group mb-3">
  ...
  <option value="0" > Today</option>
   ...
   <div class="col-md-6 col-sm-12 col-xs-12 form-group" id="custom" hidden>
<div class="input-group mb-3">
  <div class="input-group-prepend">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <form method="post"  action="{{route('report.schedule_report',['type'=>'expiry'])}}" id="schedule_report_form" name="schedule_report_form">
  ...
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-6 col-form-label text-danger">Start date *</label>
    <div class="col-sm-6">
