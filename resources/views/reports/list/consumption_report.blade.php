...
<form method="post" id="expiry_form">
  ...
  <input type="hidden" class="form-control" id="consumption_report" value="{{route('report.consumption_table')}}">
...
<!-------end modal-------------------->
 ...
 @push('js')
       <script src="{{asset('assets/admin/js/inventory/reports/consumption.js')}}"> </script>
