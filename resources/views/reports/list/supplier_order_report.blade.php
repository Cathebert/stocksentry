...
<nav aria-label="breadcrumb">
  ...
  <i class="fa fa-clock"> Schedule</i>
                   ...
                   <div class="row" >
      <div class="col-sm-12">
       @include('reports.list.requisition_header')  
    <div class="card">
...
<form method="post" id="expiry_form">
          @csrf
               ...
               <input type="hidden" class="form-control" id="supplier-orders" value="{{route('report.supplier_order')}}">
             <input type="hidden" class="form-control" id="frequency_change" value="{{route('change_frequency')}}"/>
             <input type="hidden" class="form-control" id="supplier_details"  value="{{route('report.getorderdetails')}}"/>
             <input type="hidden" class="form-control" id="supplier-orders_by_period" value="{{route('report.supplier_order_by_period')}}"/>
             <input type="hidden" class="form-control" id="supplier-orders_by_location" value="{{route('report.supplier_order_by_location')}}"/>
                          <input type="hidden" class="form-control" id="supplier-orders_by_supplier" value="{{route('report.supplier_order_by_supplier') }}"/>
...
<!-- Content Row -->
     ...
     <div class="col-xl-3 col-md-4 mb-4" hidden>
        ...
        <table class="table table-sm" id="supplier_order_table" width="100%">
...
<!-------end modal-------------------->
 ...
 @push('js')
       <script src="{{asset('assets/admin/js/inventory/reports/supplier_order.js')}}"> </script>
