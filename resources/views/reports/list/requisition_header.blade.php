...
<ul class="nav navbar-right panel_toolbox" style="float:right">
  ...
  <ul id="myTab" class="nav nav-tabs " role="tablist">
     <li role="presentation" class="@if(Request::segment(2)=='requisition-report')active @ else @endif" role="presentation" >
        <a class="nav-link @if(Request::segment(2)=='requisition-report')active @ else @endif" role="tab" type="button" href="{{route('requisition.report')}}"><strong>Store Orders</strong></a>
        </li>

  
  <li role="presentation" class="@if(Request::segment(2)=='supplier_order_report')active @ else @endif">
    <a class="nav-link @if(Request::segment(2)=='supplier_order_report')active @ else @endif"   role="tab" type="button"  href="{{route('report.supplier-order')}}"><strong>Supplier Orders</strong></a>
  </li>
