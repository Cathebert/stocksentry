...
<form method="post" id="expiry_form">
  ...
  <input type="hidden" class="form-control" id="load-requisition" value="{{route('report.load-requisition')}}">
 ...
 <input type="hidden" class="form-control" id="generate_report" value="{{route('report.download')}}"/> 
   <input type="hidden" id="get_details" value="{{route('report.requisition-more-data')}}"/>
    <input type="hidden" id="load_by_location"    value="{{route('report.load_by_location')}}"/>
...
<!-- Content Row -->
     ...
     <div class="col-xl-3 col-md-4 mb-4" hidden>
        ...
        <table class="table table-sm" id="requistion_table" width="100%">
...
<!-------end modal-------------------->
 ...
 @push('js')
       <script src="{{asset('assets/admin/js/inventory/reports/requisition.js')}}"> </script>
