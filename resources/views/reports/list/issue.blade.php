...
<!-- Content Row -->
     ...
     <div class="col-xl-3 col-md-4 mb-4" hidden>
        ...
        <table class="table table-sm" id="issue_table" width="100%">
<thead class="thead-light">
    <tr>
      
       <th scope="col"></th>
     <th scope="col">Stock Issue #</th>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <form method="post"  action="{{route('report.schedule_report',['type'=>'issue'])}}" id="schedule_report_form" name="schedule_report_form">
  @csrf
...
<!-------end modal-------------------->
 ...
 @push('js')
       <script src="{{asset('assets/admin/js/inventory/reports/issue.js')}}"> </script>
