     <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="{{ route('user.update') }}" id="edit_user_form">
                                                         <input type="hidden" id="check" name="check" value="0"/>
                                                        <input type="hidden" id="id" name="id" value="{{$id}}"/>
                                                            <input type="hidden" id="update_url"  value="{{ route('user.update') }}"/>
                                                        ...
                                                        @endif
                                                            ...
                                                            <div class="col-md-4 form-group"  id='not_coldroom'>
                                                                ...
                                                                <select class="form-control" id="user_role" name="user_type" style="width: 75%">
                                                                        ...
                                                                        <option value="4" {{ $user->authority == 4 ? 'selected' : '' }}>ColdRoom Manager</option>
