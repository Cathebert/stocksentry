...
<form method="post" id="consume_form">
  ...
  <input type="hidden" class="form-control" id="item_search" value="{{route('section.search_adjustment')}}">
...
<div class="input-group mb-3">
 ...
 <input type="text" aria-label="First name" class="form-control"  name="searchtext" placeholder="Search Item by Name or Code" id="search_item">
...
<br>
 <button type="button" class="btn btn-primary" id="adjust">Submit</button>
  ...
  @push('js')
     <script src="{{asset('assets/admin/js/section/section_stock_adjustment.js')}}"> </script>
     @endpush