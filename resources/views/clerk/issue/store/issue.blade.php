...
<div class="col-md-3 col-sm-12 col-xs-12 form-group" id="req"  >
 ...
 <div class="col-md-2 col-sm-12 col-xs-12 form-group" >
    ...
    <input type="date" class="form-control" id="issue_date" value="{{ date('Y-m-d') }}" name="issue_date"   readonly>
...
<hr><br>
 ...
 <button type="button" class="btn  btn-primary btn-sm " style="text-color:white"id="save_issue" style="" onclick="showApprovals()"><i class="fa fa-check" ></i>Pending Approvals  <span class="badge badge-pill badge-danger" ></span></button>&nbsp;&nbsp;
