                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                               Sections</div>
                                                <a href="{{route('sections.show')}}" style="text-decoration:none">
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$lab_sections??'0' }}</div>
                                        </a>
                                        </div>
                                        <div class="col-auto">
...
<input type="hidden" id="requisition_chart" value="{{route('dashboard.lab_manager_requisition')}}"/>
<input type="hidden" id="orders_chart" value="{{route('dashboard.lab_manager_orders')}}"/>
<input type="hidden" id="period-chart" value="{{route('dashboard.lab_manager_period')}}"/>
