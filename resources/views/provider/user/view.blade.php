                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="{{ route('lab_user.update', $user->id) }}" id="edit_user_form">
                                                        @csrf
                                                        @method('put')
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 form-group">
                                                                    ...
                                                                    <select class="form-control" id="lab_id" name="lab_id" style="width: 75%" readonly>
                                                                        <option value="{{ $labs->id }}" selected>{{ $labs->lab_name }}</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="modal fade" id="deleteUserModal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteUserModalLabel{{ $user->id }}" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                    <form action="{{ route('lab_user.destroy', ['id'=>$user->id]) }}" method="POST">
                                                        @csrf
                                                        @method('post')
