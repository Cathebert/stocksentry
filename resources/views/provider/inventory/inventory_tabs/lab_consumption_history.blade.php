...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Consumption History</li>
  </ol>
</nav>
  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <h5 class="card-title"> <strong>Consumption  Taken</strong></h5>
...
<form method="post" id="consume_form">
          @csrf
         <input type="hidden" class="form-control" id="consumption_taken_history_url" value="{{route('consumption.history_load')}}">
       <input type="hidden" id="viewconsumptionTakenDetails" value="{{route('consumption.view_details')}}"/>
...
<hr>
        ...
        <table class="table table-sm table-hover" id="consumption_history" width="100%">
<thead class="thead-light">
  ...
  <div class="modal-dialog modal-lg" role="document" >
    ...
    @push('js')
    <script src="{{asset('assets/admin/js/inventory/consumption_taken_history.js')}}"> </script>
