...
<input type="hidden" class="form-control"  id="issue_report" value="{{route('lab_manager_report.issue_table')}}">
 ...
 <input type="hidden" class="form-control" id="out_of_stock" value="{{route('lab_manager_report.load_out_of_stock')}}"/>
 <input type="hidden" class="form-control" id="stock_out_details" value="{{route('lab_manager_report.stock_out_details')}}"/>
...
<!-- Content Row -->
     ...
     <div class="col-xl-3 col-md-4 mb-4" hidden>
        ...
        <table class="table table-bordered table-striped" id="out_of_stock_table" width="100%">
...
<!-------end modal-------------------->
 ...
 @push('js')
       <script src="{{asset('assets/moderator/reports/out_of_stock.js')}}"> </script>
