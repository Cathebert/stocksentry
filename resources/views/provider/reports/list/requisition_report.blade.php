...
<form method="post" id="expiry_form">
  ...
  <input type="hidden" class="form-control" id="load-requisition" value="{{route('lab_manager_report.load-requisition')}}">
 ...
 <input type="hidden" class="form-control" id="generate_report" value="{{route('lab_manager_report.download')}}"/> 
   <input type="hidden" id="get_details" value="{{route('lab_manager_report.requisition-more-data')}}"/>
    <input type="hidden" id="load_by_location"    value="{{route('lab_manager_report.load_by_location')}}"/>
<input type="hidden" id="load-requisition_by_period" value="{{route('lab_manager_report.load_by_period')}}"/>
            <div class="row">
...
<!-- Content Row -->
     ...
     <div class="col-xl-3 col-md-4 mb-4" hidden>
        ...
        <table class="table table-bordered table-striped" id="requistion_table" width="100%">
...
<!-------end modal-------------------->
 ...
 @push('js')
       <script src="{{asset('assets/moderator/reports/requisition.js')}}"> </script>
