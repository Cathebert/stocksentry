...
<hr><br>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <button type="button" class="btn btn-secondary btn-sm " id="add_new_issue" style="" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-plus" ></i>Add</button>&nbsp;&nbsp;
          <button type="button" class="btn btn-success btn-sm " id="save_issue" style="" disabled><i class="fa fa-save" id="show_loader"></i> Save</button>&nbsp;&nbsp;
 ...
 <button type="button" class="btn  btn-success btn-sm " style="text-color:white"id="show_approved" style="" ><i class="fa fa-check"></i>Approved <span class="badge badge-pill badge-danger" id="approved_badge">{{$approved}}</span></button>&nbsp;&nbsp;
   ...
   <br>
        ...
        <table class="table table-bordered table-striped table-sm table-hover" id="items">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="check_quantity" value="{{route('inventory.check_quantity')}}"/>
         <div class="table-responsive">
        <table class="table table-bordered table-striped table-sm table-hover" id="issue_items" width="100%">
<thead class="thead-light">
    <tr>
       <th scope="col"></th>
